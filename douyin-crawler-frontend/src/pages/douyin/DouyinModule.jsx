              ...
              <div className="bg-gradient-to-r from-pink-600 to-red-600 rounded-2xl p-8 text-white">
                ...
                <div className="flex flex-wrap gap-4">
                  <button
                    ...
                    className="bg-white text-pink-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all flex items-center gap-2"
                  >
              ...
              <div className="bg-gray-800 rounded-xl p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="flex gap-4">
                    <div className="w-10 h-10 bg-pink-500 rounded-full flex items-center justify-center flex-shrink-0 text-lg font-bold">
                      1
                    </div>
                    <div>
